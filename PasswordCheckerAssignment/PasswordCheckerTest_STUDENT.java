...
public class PasswordCheckerTest_STUDENT {
	...
	public void testIsValidPasswordNoUpperAlpha() {
		try {
			PasswordCheckerUtility.isValidPassword("hey$32");
	...
	public void testIsValidPasswordNoLowerAlpha() {
		try {
			PasswordCheckerUtility.isValidPassword("HEYY$32UZ");
			assertTrue(PasswordCheckerUtility.isValidPassword("heyy$32uZ"));
	...
	public void testIsWeakPassword() {
		try {
			PasswordCheckerUtility.isWeakPassword("he3@2");
	...
	public void testIsValidPasswordInvalidSequence() {
		try {
			PasswordCheckerUtility.isValidPassword("abdH#33");
	...
	public void testIsValidPasswordNoDigit() {
		try {
			assertTrue(PasswordCheckerUtility.isValidPassword("abddH#33"));
			PasswordCheckerUtility.isValidPassword("abddH#");
