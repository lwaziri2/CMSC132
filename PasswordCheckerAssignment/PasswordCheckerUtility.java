...
public class PasswordCheckerUtility {
	...
	public static boolean isValidPassword(String password)
			...
			InvalidSequenceException, NoSpecialCharacterException, WeakPasswordException {
	...
	public static boolean isWeakPassword(String password)
			throws WeakPasswordException, LengthException, NoDigitException, NoUpperAlphaException,
