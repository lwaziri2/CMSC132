...
/**
 * This TownGraphManager class implements the TownGraphManagerInterface, which provides
 * all the necessary methods for adding towns and roads to a graph, as well as retrieving information
 * about towns and roads, and find paths between the towns.
 * @author Lima Waziri
 *
 */
