...
/**
 * This Graph class represents a graph data structure which has towns and roads between them.
 * It also implements the GraphInterface<Town, Road> interface which provides methods to successfuly 
