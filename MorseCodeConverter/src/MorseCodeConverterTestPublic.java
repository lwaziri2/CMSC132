...
public class MorseCodeConverterTestPublic {
	...
	/**
	 * Student test for convertToEnglish(String code)
	 */
	@Test
	public void convertToEnglishStudentTest() {
		String code = ".... . .-.. .-.. --- ";
		String words = "hello";
		assertEquals(words, MorseCodeConverter.convertToEnglish(code));
	}
	
	/**
	 * Student test for convertToEnglish(File codeFile)
	 */
	@Test
	public void convertToEnglishStudentTestFile() throws FileNotFoundException{
		File file = new File("test.txt"); 
		try {
			assertEquals("hello", MorseCodeConverter.convertToEnglish(file));
		} catch (FileNotFoundException e) {
